...
def render(exp):
    ...
    h += f'<header class="tn-hero"><div class="kicker">Trải nghiệm cốt lõi Mường Cốc</div><h1>{e(exp["title"])}</h1><p class="tagline">{e(exp["tagline"])}</p></header>'
...
EXP1 = {
    ...
    "timeline": [
        {"time": "08h00", "head": "Chào đón tại Tourism Hub Đồi Dùng",
        ...
        {"time": "08h30", "head": "Hóa thân thành người Mường", "sub": "Gặp gỡ chủ nhà ông Chế",
        ...
        {"time": "09h30", "head": "Gió Núi Farmstay — mô hình VAC", "sub": "Chạm tay vào nông nghiệp xanh",
        ...
        {"time": "11h30", "head": "Mộc Mường Cốc Farmstay", "sub": "Bữa cơm người Mường",
        ...
        {"time": "14h30", "head": "Nét Thanh — Không gian văn hóa Mường", "sub": "Giữ hồn quê – Lan tỏa bản sắc",
...
EXP2 = {
    ...
    "timeline": [
        {"time": "08h00", "head": "Chào đón tại Gió Núi Farmstay", "body": ["Trà thảo mộc nhà trồng; giới thiệu mô hình VAC tuần hoàn, 5 Không và cam kết Net Zero. Nhận nón lá, ủng, giỏ tre."]},
        ...
        {"time": "10h00", "head": "Chăn trâu trên đồng", "body": ["Dắt trâu ra đồng cỏ, tập làm mục đồng, chụp ảnh giữa khung cảnh đồng quê bản Mường."]},
        {"time": "10h45", "head": "Hái rau & trồng rau theo mùa", "body": ["Thu hoạch rau vườn theo mùa; tự tay gieo một luống rau — để lại dấu chân xanh cho farmstay."]},
        {"time": "11h15", "head": "Kéo vó & câu cá dưới ao", "body": ["Lội ao kéo vó, buông cần câu cá. Cá bắt được mang thẳng vào bếp."]},
        {"time": "12h00", "head": "Ăn trưa — Mâm cơm Farm to Table", "body": ["Tự xiên nướng cá vừa bắt trên than hồng (chấm muối mắc khén), cùng gia chủ nấu mâm cơm nhà nông: gà đồi, rau vườn, trứng, canh quê — tất cả từ vườn ra mâm."]},
